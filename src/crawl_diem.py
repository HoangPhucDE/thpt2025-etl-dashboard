...
def main():
    ...
    with open(CSV_FILE, mode='a', newline='', encoding='utf-8') as fileCrawled:
        try:
            fieldnames = [
                "SBD", "TONGDIEM", "TOAN", "VAN", "NGOAI_NGU",
                "SU", "DIA", "GDKT_PL", "LI", "HOA", "SINH",
                "TIN_HOC", "GIAO_DUC_CONG_DAN", "CN_CONG_NGHIEP",
                "CN_NONG_NGHIEP", "NGAY_SINH"
            ]
            writer = csv.DictWriter(fileCrawled, fieldnames=fieldnames, extrasaction='ignore')
            ...
            print("Đã kết thúc, file CSV được đảm bảo lưu.")
